...
class NavMessageRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NavMessageRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NavMessageRequest
    let len;
    let data = new NavMessageRequest(null);
  ...
  static datatype() {
    ...
    return 'my_turtlebot_navigation/NavMessageRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavMessageRequest(null);
...
class NavMessageResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NavMessageResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NavMessageResponse
    let len;
    let data = new NavMessageResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavMessageResponse(null);
...
module.exports = {
  Request: NavMessageRequest,
  Response: NavMessageResponse,
  md5sum() { return '920ca5ca095e1b5230fc32da338a974c'; },
  datatype() { return 'my_turtlebot_navigation/NavMessage'; }
};
